...
class LSTM_Transformer(nn.Module):
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim, dropout_prob):
        ...
        encoder_layer = nn.TransformerEncoderLayer(d_model=256, nhead=12)
        self.encoder = nn.TransformerEncoder(encoder_layer, num_layers=8)
        
        decoer_layer = nn.TransformerDecoderLayer(d_model = 128, n_head = 8)
    ...
    def forward(self, x):
        ...
        attention_vector = self.encoder(out)
        out = attention_vector * out
